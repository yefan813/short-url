...
和产生冲突的概率。我们不回去考虑反向解码的性能或者难度，因为我们之直接将生成的 hash 字符串和长链接映射，不需反向生成。  
  ...
  对长链(https://github.com/wangzheng0822/ratelimiter4j)做 MurmurHash 计算，得到的哈希值为 181338494，于是我们现在得到的短链为 固定短链域名+哈希值 = http://xxxx.cn/181338494
